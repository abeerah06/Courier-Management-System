namespace CourierManager.Views
{
    partial class CustomerView
    {
        ...
        private void InitializeComponent()
        {
            ...
            SetTsb(tsbAdd, "Add Customer", Color.FromArgb(27, 140, 60));
            ...
            dgv.Columns.AddRange([colId, colName, colPhone, colCity, colEmail, colAddress, colCreated]);
            ...
            SetCol(colName, "Name", "Name", 180);
            SetCol(colPhone, "Phone", "Phone", 130);
            SetCol(colCity, "City", "City", 120);
            SetCol(colEmail, "Email", "Email", 180);
            SetCol(colAddress, "Address", "Address", 200);
            SetCol(colCreated, "Registered", "CreatedAt", 130);
            colCreated.DefaultCellStyle.Format = "dd MMM yyyy";
        ...
        private DataGridViewTextBoxColumn colId, colName, colPhone, colCity, colEmail, colAddress, colCreated;
    }
}
